...
//リンク    //,{name:"",linkUrl:"",}
const link = [
    { name: 'TALTO', linkUrl: 'https://talto.cc/' },
    { name: 'ソロジャーナルの森', linkUrl: 'https://soloj.hodo49.com/' },
    { name: 'itch.io', linkUrl: 'https://itch.io/' },
    { name: 'Booth', linkUrl: 'https://booth.pm/ja' },
];
...
//注意事項
const terms = [
    'プレイログの公開は媒体を問わずご自由にどうぞ。意にそぐわないプレイ結果や解釈の改変もお好きになさってください。',
...
const scenario = [
    ...
    },
    {
        explain: {
            ...
            2: '切手の画像を作れるテンプレートを同封しようと思っていますが、未定です。',
        },
        url: { 0: 'https://talto.cc/projects/EE38t57pHyhCxPNVv51Xw', 1: '' },
        urlName: { 0: 'TALTO', 1: 'itch.io' },
    },
    {
        explain: {
            1: 'ある研究に狂った研究者の最後の数日を記すソロジャーナルシナリオです。',
            2: '「人倫にもとる手記」「因果応報で滅ぶ研究者」を見たくて作りました。そういう気分を高めて遊ぶといいかもしれません。',
            0: '制作中です。',
        },
        url: { 0: '', 1: '' },
        urlName: { 0: 'TALTO', 1: 'itch.io' },
