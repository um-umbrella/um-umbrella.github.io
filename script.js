...
const workLists = [
    ...
    {
        name: 'バナー画像を作るやつ',
        url: '../works/banner_canvas/',
        etc: 'バナーやその他の簡単な画像を作る。表示のズレがまだある。',
        thum: 'img/w11.png',
    },
    {
        name: '目次追加JS',
        url: '../works/add_tablecontents/',
        etc: 'ページ内に目次を追加する。楽をすることだけを考えている。',
        thum: 'img/thum.jpg',
    },
    {
        name: '中原中也同盟',
    ...
    {
        name: 'ソロジャーナル同盟',
        url: '../union/solo-journaling/',
        etc: '同盟。デザインを参考にしつつ。いい感じ。',
        thum: 'img/w13.jpg',
    },
    {
        name: '深海同盟',
